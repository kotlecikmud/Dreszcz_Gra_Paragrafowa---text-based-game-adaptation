...
message = f'Original language of source material is Polish. Translations will be implemented later, when whole polish version is ready. Audio dialogs will also be translated, but for that I will need a lot of time.{constants.input_sign}'
...
def gb_update(language='pl'):
    if language == 'en':
        print(choices['en'])
        gamebook = {("00a", f"\r{constants.def_txt_clr}While wandering through the underground, you will find different types of weapons and items.\
        ...
        print(choices['pl'])
        gamebook = {("00a", f"\r{constants.def_txt_clr}Wędrując po podziemiach będziesz znajdował inne rodzaje broni i przedmioty.\
                ...
                \nTylko Ty możesz wydrzeć ich Wielką Tajemnicę. Ruszaj!"), ("01", 'Wejście do podziemi jest szerokie, obrośnięte trawą i bujnymi krzewami.\
        ...
        functions.debug_message('not available')


gb_update()  # initialize gamebook
