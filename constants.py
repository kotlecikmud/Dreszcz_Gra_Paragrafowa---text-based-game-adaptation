...
# /// sound mixing
pygame.mixer.init(frequency=44100, size=-16, channels=1, buffer=2**12)  # Initialize the mixer module with the specified settings
...
# główny ekwipunek
main_eq = ['plecak na Prowiant', f'prowiant ({eatables_count} porcji)', 'tarcza', 'miecz', f'złoto({gold_amount} sztuk)']
