...
# /// 002:
# /// GARAZAN
entity_002 = obj_class.Entity(f'{constants.entity_txt_clr}GARAZANf{constants.def_txt_clr}', 10, 10, 10, 10, True, True)
...
# /// 032:
# /// WILKOLUDY
entity_032 = obj_class.Entity(f'{constants.entity_txt_clr}WILKOLUDY{constants.def_txt_clr}', 8, 8, 7, 7, True, False)
...
# /// 069:
# /// UPIÓR(1)
entity_069_1 = obj_class.Entity(f'{constants.entity_txt_clr}UPIÓR{constants.def_txt_clr}', 5, 5, 3, 3, True, False)
...
# - - - - - - - - -
# /// UPIÓR(2)
entity_069_2 = obj_class.Entity(f'{constants.entity_txt_clr}UPIÓR{constants.def_txt_clr}', 5, 5, 4, 4, True, False)
...
# /// 092:
# /// MINOTAUR
entity_092 = obj_class.Entity(f'{constants.entity_txt_clr}MINOTAUR{constants.def_txt_clr}', 10, 10, 10, 10, True, False)
...
# /// 109:
# /// KARMAA
entity_109 = obj_class.Entity(f'{constants.entity_txt_clr}KARMAA{constants.def_txt_clr}', 7, 7, 8, 8, True, False)
...
# /// 116:
# /// ORK
entity_116 = obj_class.Entity(f'{constants.entity_txt_clr}ORK{constants.def_txt_clr}', 6, 6, 4, 4, True, False)
...
# /// 184:
# /// DEMON
entity_184 = obj_class.Entity(f'{constants.entity_txt_clr}DEMON{constants.def_txt_clr}', 7, 7, 6, 6, True, True)
...
# /// 238:
# /// GREMLIN(1)
entity_238_1 = obj_class.Entity(f'{constants.entity_txt_clr}GREMLIN{constants.def_txt_clr}', 5, 5, 3, 3, True, False)
...
# - - - - - - - - -
# /// LICHA(2)
entity_238_2 = obj_class.Entity(f'{constants.entity_txt_clr}LICHA{constants.def_txt_clr}', 6, 6, 5, 5, True, False)
...
# - - - - - - - - -
# /// BRONGO(3)
entity_238_3 = obj_class.Entity(f'{constants.entity_txt_clr}BRONGO{constants.def_txt_clr}', 8, 8, 4, 4, True, False)
...
# - - - - - - - - -
# /// ORKONIK(4)
entity_238_4 = obj_class.Entity(f'{constants.entity_txt_clr}ORKONIK{constants.def_txt_clr}', 6, 6, 4, 4, True, False)
...
# - - - - - - - - -
# /// SAMASKÓRA(5)
entity_238_5 = obj_class.Entity(f'{constants.entity_txt_clr}SAMASKÓRA{constants.def_txt_clr}', 6, 6, 5, 5, True, False)
...
# /// 317:
# /// OGRE
entity_317 = obj_class.Entity(f'{constants.entity_txt_clr}OGRE{constants.def_txt_clr}', 8, 8, 10, 10, True, False)
...
# /// 332:
# /// TROLL
entity_332 = obj_class.Entity(f'{constants.entity_txt_clr}TROLL{constants.def_txt_clr}', 8, 8, 8, 8, True, False)
