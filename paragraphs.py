...
def _30():
    functions.dub_play('30', 'dreszcz_p_30.mp3')
    _xx()


def _31():
    functions.dub_play('31', 'dreszcz_p_31.mp3')
    path_strings = []
...
def _32():
    functions.dub_play('32', 'dreszcz_p_32.mp3')
    _xx()


def _33():
    functions.dub_play('33', 'dreszcz_p_33.mp3')
    _xx()


def _34():
    functions.dub_play('34', 'dreszcz_p_34.mp3')
    _xx()


def _35():
    functions.dub_play('35', 'dreszcz_p_35.mp3')
    _xx()


def _36():
    functions.dub_play('36', 'dreszcz_p_36.mp3')
    _xx()
...
def _38():
    functions.dub_play('38', 'dreszcz_p_38.mp3')
    _xx()


def _39():
    functions.dub_play('39', 'dreszcz_p_039.mp3')
...
def _43():
    functions.dub_play('43', 'dreszcz_p_43.mp3')
    _xx()
...
def _46():
    functions.dub_play('46', 'dreszcz_p_46.mp3')
    _xx()


def _47():
    functions.dub_play('47', 'dreszcz_p_47.mp3')
    _xx()


def _48():
    functions.dub_play('48', 'dreszcz_p_48.mp3')
    _xx()


def _49():
    functions.dub_play('49', 'dreszcz_p_49.mp3')
    _xx()


def _50():
    functions.dub_play('50', 'dreszcz_p_50.mp3')
...
def _59():
    functions.dub_play('59', 'dreszcz_p_59.mp3')
    path_strings = ['tak', 'nie']
...
def _70():
    functions.dub_play('70', 'dreszcz_p_70.mp3')
    _xx()


def _75():
    functions.dub_play('75', 'dreszcz_p_075.mp3')
    path_strings = []
...
def _76():
    functions.dub_play('76', 'dreszcz_p_76.mp3')
    _xx()


def _82():
    functions.dub_play('82', 'dreszcz_p_82.mp3')
    _xx()


def _89():
    functions.dub_play('89a', 'dreszcz_p_089a.mp3')
    functions.stats_change('Szczęscie', constants.s_count, 2)
    functions.stats_change('Złoto', constants.gold_amount, 3)
    functions.dub_play('89b', 'dreszcz_p_089b.mp3')
    path_strings = []
...
def _100():
    functions.dub_play(100, 'dreszcz_p_100.mp3')
    _xx()
...
def _102():
    functions.dub_play('102', 'dreszcz_p_102.mp3')
    path_strings = ['zachód', 'północ', 'wschód', 'południe']
...
def _103():
    functions.dub_play('103', 'dreszcz_p_103.mp3')
    path_strings = []
...
def _104():
    functions.dub_play('104', 'dreszcz_p_104.mp3')
    path_strings = []
...
def _106():
    functions.dub_play('106', 'dreszcz_p_106.mp3')
...
def _113():
    functions.dub_play('113', 'dreszcz_p_113.mp3')
...
def _115():
    ...
    functions.dub_play('115', 'dreszcz_p_115.mp3')
...
def _119():
    functions.dub_play('119', 'dreszcz_p_119.mp3')
...
def _120():
    functions.dub_play('120', 'dreszcz_p_120.mp3')
    path_strings = []
...
def _123():
    functions.dub_play('123', 'dreszcz_p_123.mp3')
    path_strings = []
...
def _128():
    functions.dub_play('128', 'dreszcz_p_128.mp3')
    _xx()


def _130():
    functions.dub_play('130', 'dreszcz_p_130.mp3')
    path_strings = []
...
def _132():
    functions.dub_play('132', 'dreszcz_p_132.mp3')
    path_strings = ['Tak', 'Nie']
...
def _136():
    functions.dub_play('136', 'dreszcz_p_136.mp3')
    path_strings = []
...
def _146():
    functions.dub_play('146', 'dreszcz_p_146.mp3')
    path_strings = []
    actions = ['paragraphs._64()']
    functions.pth_selector(path_strings, actions)
...
def _153():
    functions.dub_play('153', 'dreszcz_p_153.mp3')
...
def _158():
    functions.dub_play('158', 'dreszcz_p_158.mp3')
...
def _160():
    functions.dub_play('160', 'dreszcz_p_160.mp3')
    path_strings = []
...
def _170():
    functions.dub_play('170', 'dreszcz_p_170.mp3')
...
def _176():
    functions.dub_play('176', 'dreszcz_p_176.mp3')
...
def _177():
    functions.dub_play('177', 'dreszcz_p_177.mp3')
...
def _178():
    functions.dub_play('178', 'dreszcz_p_178.mp3')
    path_strings = []
...
def _180():
    if entities.room_364.visit_count <= 2:
        functions.dub_play('180', 'dreszcz_p_180.mp3')
...
def _181():
    functions.dub_play('181', 'dreszcz_p_181.mp3')
...
def _182():
    functions.dub_play('182', 'dreszcz_p_182.mp3')
    path_strings = ['tak', 'nie']
...
def _183():
    functions.dub_play('183', 'dreszcz_p_183.mp3')
    _xx()


def _184():
    functions.dub_play('184', 'dreszcz_p_184.mp3')
...
def _186():
    functions.dub_play('186', 'dreszcz_p_186.mp3')
    path_strings = ['A', 'B', 'C']
...
def _190():
    functions.dub_play('190', 'dreszcz_p_190.mp3')
    path_strings = []
    actions = ['paragraphs._115()']
    functions.pth_selector(path_strings, actions)
...
def _212():
    functions.dub_play('212', 'dreszcz_p_212.mp3')
...
def _226():
    functions.dub_play('226', 'dreszcz_p_226.mp3')
    path_strings = ['tak', 'nie']
    actions = [
...
def _228():
    functions.dub_play('228', 'dreszcz_p_228.mp3')
    path_strings = []
...
def _233():
    functions.dub_play('233', 'dreszcz_p_233.mp3')
    _xx()


def _234():
    functions.dub_play('234', 'dreszcz_p_234.mp3')
    path_strings = ['tak', 'nie']
...
def _238a():
    functions.dub_play('238a', 'dreszcz_p_238a.mp3')
...
def _241():
    functions.dub_play('241', 'dreszcz_p_241.mp3')
    path_strings = []
...
def _251():
    ...
    functions.dub_play('251', 'dreszcz_p_251.mp3')
    path_strings = []
    actions = ['paragraphs._39()']
    functions.pth_selector(path_strings, actions)
...
def _264():
    functions.dub_play('264', 'dreszcz_p_264.mp3')
    path_strings = []
    actions = ['paragraphs._102()']
    functions.pth_selector(path_strings, actions)
...
def _265():
    functions.dub_play('265', 'dreszcz_p_265.mp3')
    _xx()


def _268():
    functions.dub_play('268', 'dreszcz_p_268.mp3')
    functions.pth_selector(entities.room_310, entities.room_310, 'paragraphs._317a()', 'paragraphs._102()')


def _269():
    functions.dub_play('269', 'dreszcz_p_269.mp3')
...
def _271():
    functions.dub_play('271a', 'dreszcz_p_271a.mp3')
...
def _284():
    functions.dub_play('284', 'dreszcz_p_284.mp3')
...
def _287():
    functions.dub_play('287', 'dreszcz_p_287.mp3')
    _xx()


def _291():
    functions.dub_play('291', 'dreszcz_p_291.mp3')
    functions.stats_change('Wytrzymałość', constants.w_count, -2)
    path_strings = []
    actions = ['paragraphs._330()']
    functions.pth_selector(path_strings, actions)
...
def _296():
    functions.dub_play('296', 'dreszcz_p_296a.mp3')
    functions.eatables()
...
def _305():
    functions.dub_play('305', 'dreszcz_p_305.mp3')
...
def _310():
    functions.dub_play('310', 'dreszcz_p_310.mp3')
    path_strings = []
...
def _316():
    functions.dub_play('316', 'dreszcz_p_316.mp3')
    path_strings = []
...
def _317a():
    functions.dub_play('317a', 'dreszcz_p_317a.mp3')
...
def _317b():
    functions.dub_play('317b', 'dreszcz_p_317b.mp3')
...
def _330():
    functions.dub_play('330', 'dreszcz_p_330.mp3')
    path_strings = []
...
def _331():
    functions.dub_play('331', 'dreszcz_p_331a.mp3')
    path_strings = []
